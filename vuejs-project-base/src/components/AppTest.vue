...
<template>
  <div class="container">
    ...
    <div>
      ...
      <!--Директива v-show во Vue-->

      <p>Директива v-show</p>
      <!--Отличия от v-if в том, что элемент с v-show будет всегда отрисовываться и оставаться в DOM, а переключаться будет лишь его CSS свойство display.
